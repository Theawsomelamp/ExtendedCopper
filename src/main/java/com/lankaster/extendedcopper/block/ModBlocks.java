...
public class ModBlocks {
    ...
    public static final Block COPPER_BUTTON = registerBlock("copper_button",
            new ModStoneButtonBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.of(Material.METAL).noCollision().strength(4.0F).requiresTool()));

    public static final Block EXPOSED_COPPER_BUTTON = registerBlock("exposed_copper_button",
            new ExposedButtonBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.of(Material.METAL).noCollision().strength(4.0F).requiresTool()));

    public static final Block WEATHERED_COPPER_BUTTON = registerBlock("weathered_copper_button",
            new WeatheredButtonBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.of(Material.METAL).noCollision().strength(4.0F).requiresTool()));

    public static final Block OXIDIZED_COPPER_BUTTON = registerBlock("oxidized_copper_button",
            new OxidizedButtonBlock(Oxidizable.OxidationLevel.UNAFFECTED, FabricBlockSettings.of(Material.METAL).noCollision().strength(4.0F).requiresTool()));
    ...
    public static final Block COPPER_PRESSURE_PLATE = registerBlock("copper_pressure_plate",
            new ModPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING,
                    AbstractBlock.Settings.of(Material.METAL).requiresTool().noCollision().strength(4.0F)));
