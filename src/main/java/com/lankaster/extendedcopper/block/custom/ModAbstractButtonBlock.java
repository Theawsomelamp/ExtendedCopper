...
public abstract class ModAbstractButtonBlock extends WallMountedBlock {
    ...
    private final int pressLength;

    protected ModAbstractButtonBlock(int pressLength, Settings settings) {
        super(settings);
